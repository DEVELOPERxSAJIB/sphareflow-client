    ...
    <div className="lg:px-20 md:px-5 sm:px-5 xs:px-5 pt-5 px-4 h-screen">
      ...
      <div className="flex flex-col lg:flex-row mt-5">
        ...
        <div className="w-full lg:w-[70%] md:w-[100%] sm:w-[100%] xs:w-[100%]">
          ...
          <div className="mt-7">
            <div className="">
              <h3 className="font-bold font-switzer text-[20px]">Stripe</h3>

              {/* {user?.stripeAccountId && user?.stripeVerified ? (
                <div className="bg-white min-h-24 p-6 rounded-2xl mt-4">
                  <p>Your stripe account is connected and verified</p>
                </div>
              ) : user?.stripeAccountId && !user?.stripeVerified ? (
                <div className="bg-white min-h-24 p-6 rounded-2xl mt-4">
                  <p>Your account is connected but not verified</p>
                </div>
              ) : (
                <p>Okay</p>
              )} */}
              <div className="overflow-hidden rounded-2xl mt-4">
                <div className="bg-white min-h-24 p-6">
                  <p>Your account is not connected</p>
                  {/* <ConnectStripe /> */}
                </div>
                <div className="bg-[#FFFCF3] p-6 flex justify-between items-center">
                  <span className="text-sm">Connect your account now</span>
                  <button className="hidden bg-[#0011FF] text-[#fff] px-5 py-2 rounded-[22px]">
                    Connect Stripe
                  </button>
                </div>
              </div>
