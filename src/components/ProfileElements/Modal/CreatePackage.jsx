...
const CreatePackage = ({ open, setOpen }) => {
        ...
        <div className="flex min-h-full items-center justify-center p-4 text-center">
          <DialogPanel className="relative w-full sm:w-1/3 md:w-2/3 lg:w-1/3  transform overflow-hidden rounded-lg bg-white shadow-xl transition-all">
            <div className="flex p-4 justify-between items-center">
              ...
              {/* new code */}
              <div className="max-w-3xl text-start p-6 rounded-xl">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500">
                      Optional, give a sweet name to your product to attract
                      clients.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500">
                      We recommend to do 1 or 2 free revisions and charge for
                      more changes.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500">
                      Standard turnaround time is under 7 days after package
                      received.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="flex space-x-3">
                        {["3 months", "6 months", "12 months"].map(
                          (duration) => (
                            <button
                              key={duration}
                              type="button"
